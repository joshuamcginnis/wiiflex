package com.intuit.developer.QBTarget.dto
{
	...
	import com.intuit.developer.QBTarget.business.fieldmaps.Users_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class Users_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return Users_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new Users_FieldMap();}
		public function getFieldMapClass():Class						{return Users_FieldMap;}
		public function get dtoClass():Class							{return Users_DTO;}

		// MetaData Information Objects getters
		public function get Name_Info():TextField						{return Users_Info.getInstance().Name_Info;}
		public function get Avitar_Info():FileField						{return Users_Info.getInstance().Avitar_Info;}
		public function get Games_Info():DbLinkField					{return Users_Info.getInstance().Games_Info;}
		public function get AddGame_Info():URLField						{return Users_Info.getInstance().AddGame_Info;}
		public function get Entries_Info():DbLinkField					{return Users_Info.getInstance().Entries_Info;}
		public function get AddEntry_Info():URLField					{return Users_Info.getInstance().AddEntry_Info;}
		public function get DateCreated_Info():TimeStampField			{return Users_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return Users_Info.getInstance().DateModified_Info;}
		public function get RecordId_Info():RecordIdField				{return Users_Info.getInstance().RecordId_Info;}
		public function get RecordOwner_Info():UserIdField				{return Users_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return Users_Info.getInstance().LastModifiedBy_Info;}
