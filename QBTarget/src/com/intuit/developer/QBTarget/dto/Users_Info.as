package com.intuit.developer.QBTarget.dto
{
	...
	public class Users_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:Users_Info = null;

		function Users_Info(forcePrivateClass:Private)
		{
		...
		public static function getInstance():Users_Info
		{
			if(_instance == null)
				_instance = new Users_Info(new Private);
			return _instance;
		}
